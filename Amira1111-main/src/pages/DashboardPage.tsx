                ...
                {lowStock.length > 0 && (
                  <div className="pt-2">
                    <div className="flex justify-between items-center mb-2">
                      <p className="text-[11px] font-black text-rose-500 flex items-center gap-1">
                        <AlertTriangle className="w-3 h-3" /> تنبيه نقص حاد في:
                      </p>
                      <Button variant="link" size="sm" className="text-[10px] h-auto p-0 text-sky-600 font-bold" asChild>
                         <Link to="/low-stock">عرض المزيد</Link>
                      </Button>
                    </div>
